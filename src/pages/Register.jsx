    ...
    <div className="auth-page mesh-bg">
      ...
      <div className="auth-card glass-card">
        <div className="auth-card-header">
          ...
          <p>Set up your workspace and start turning chaos into art.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="auth-field">
            <label>Your Digital Address</label>
            <input
              type="email"
              placeholder="vibe-checker@domain.com"
              value={email}
      ...
      <style>{`
        ...
        .auth-card-header p {
          color: rgba(255,255,255,0.5); font-size: 0.85rem; margin: 0;
        }
        ...
        .auth-submit-btn {
          ...
          background: linear-gradient(to right, #8b5cf6, #ec4899, #60a5fa);
          color: white; font-size: 1.1rem; font-weight: 700;
          border: none; cursor: pointer;
          font-family: 'Space Grotesk', sans-serif;
          display: flex; align-items: center; justify-content: center; gap: 0.5rem;
          transition: all 0.3s; margin-top: 0.25rem;
        }
        ...
        .auth-switch-link:hover { color: white; }
